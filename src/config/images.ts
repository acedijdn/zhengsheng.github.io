...
export const images: Record<ImageKey, ImageConfig> = {
  ...
  'product-vibrator': {
    ...
    category: '产品',
    customUrl: cdnUrl('/网站/ZS0508.png'),
  },
  'product-module': {
    key: 'product-module',
    label: '扬声器',
  ...
  'solution-smart-bed': {
    ...
    category: '解决方案',
    customUrl: cdnUrl('/网站/主页智能床垫.png'),
  },
  'solution-smart-healing': {
    ...
    category: '解决方案',
    customUrl: cdnUrl('/网站/主页智能疗愈.png'),
  },
  'solution-smart-massage-chair': {
  ...
  'scenario-bed': {
    ...
    category: '使用场景',
    customUrl: cdnUrl('/网站/智能床图片修改 (7).png'),
  },
  'scenario-wellness': {
